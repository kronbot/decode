...
public class Auto_CloseBlueOp extends OpMode {
    ...
    // Define poses
    Pose start = coordinates(StartingPoseCloseBlue);
    Pose launch1 = coordinates(LaunchZoneClose1Blue);
    Pose launch11 = coordinates(LaunchZoneClose11Blue);
    Pose launch2 = coordinates(LaunchZoneClose2Blue);
    Pose intake1 = coordinates(IntakeZoneClose1Blue);
    Pose intake11 = coordinates(IntakeZoneClose11Blue);

    Pose intake2 = coordinates(IntakeZoneClose2Blue);
    Pose intake22 = coordinates(IntakeZoneClose22Blue);
    Pose launch3 = coordinates(LaunchZoneClose3Blue);
